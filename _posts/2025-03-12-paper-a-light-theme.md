...
cover_caption: "The first light theme by community member trviph"
...
- `_sass/_variables-light.scss` a new conditional set of variables for the light themes; you can start your very own theme with CSS Variables and better defaults if you aren't on the dark side  
